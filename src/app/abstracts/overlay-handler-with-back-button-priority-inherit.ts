import { BackButtonPriorityInherit } from './back-button-priority-inherit';
...
export abstract class OverlayHandlerWithBackButtonPriorityInherit extends BackButtonPriorityInherit {
