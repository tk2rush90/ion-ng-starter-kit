...
@Component({
  ...
  host: {
    '[style]': `styles`,
    class:
      'pointer-events-auto rounded-3xl fixed left-1/2 bottom-4 pr-2 pl-4 py-4 bg-white dark:bg-dark-background flex items-center gap-4 shadow-2xl dark:shadow-white/5 max-w-110 w-full',
  },
})
