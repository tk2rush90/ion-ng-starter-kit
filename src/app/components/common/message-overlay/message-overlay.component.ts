...
@Component({
  ...
  host: {
    '[style]': `styles`,
    class:
      'pointer-events-auto rounded-3xl fixed left-1/2 bottom-4 pr-2 pl-4 py-4 bg-background flex items-center gap-4 shadow-2xl max-w-110 w-full border border-solid border-foreground/5 dark:border-foreground/5',
  },
})
